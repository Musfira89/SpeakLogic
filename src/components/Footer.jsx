...
const Footer = () => {
  return (
    <>
      <footer className="bg-white text-gray-800 pt-12 pb-8 px-6 md:px-20 lg:px-36 font-sans border-t border-gray-200">
        <div className="flex flex-col md:flex-row flex-wrap justify-between gap-12">
          ...
          <div className="w-full md:w-[30%] text-sm sm:text-base text-gray-800 leading-normal sm:leading-relaxed">
            <img
              src={logo}
              alt="SpeakLogic"
              className="h-10 sm:h-12 md:h-20 mb-6 sm:mb-8"
            />
          ...
          <div className="w-full flex-1">
            ...
            <div className="space-y-4 text-sm sm:text-base">
              <div className="group cursor-pointer transition duration-300">
                ...
                <p className="text-gray-800 group-hover:text-[#47be07] transition duration-300">
